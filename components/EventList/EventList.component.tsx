    ...
    <>
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-5">
        <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight">
          <span className="inline-block w-8 h-1 rounded-full bg-linear-to-r from-[#f84464] to-[#ff2e63] align-middle mr-3" />
          {title}
        </h1>
        {showSearch && (
          <input
            ...
            className="sm:ml-auto w-full sm:w-80 bg-[#16181d] border border-[#24272e] rounded-full px-4 py-2.5 text-sm outline-none focus:border-[#f84464] focus:shadow-[0_0_0_3px_rgba(248,68,100,0.15)] transition-shadow"
          />
        )}
      </div>
          ...
          {filtered.map((event) => {
            ...
            return (
              <Link
                ...
                className="group rounded-2xl bg-[#16181d] border border-[#24272e] hover:border-[#f84464]/40 overflow-hidden shadow-lg hover:shadow-[0_16px_40px_rgba(0,0,0,0.45)] hover:-translate-y-1 transition-all duration-300"
              >
                <div
                ...
                >
                  ...
                  {soldOut ? (
                    ...
                    <span className="absolute top-3 right-3 inline-flex items-center gap-1 bg-linear-to-r from-[#f84464] to-[#ff2e63] text-white text-[11px] font-bold uppercase tracking-wide px-2.5 py-1 rounded-full animate-[neon-pulse_2s_ease-in-out_infinite]">
                ...
                <div className="p-4 flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    ...
                    {fillingFast && (
                      <p className="text-xs text-[#ff8fa3] mt-1">Only {left} seats left</p>
                    )}
                  </div>
                  <span className="shrink-0 text-sm font-bold text-[#f84464] bg-[#f84464]/10 border border-[#f84464]/20 rounded-full px-3 py-1">
                    {inr(fromPrice)}+
                  </span>
                </div>
              </Link>
