...
export default function SiteFooter() {
  return (
    <footer className="bg-[#172554] text-white/70">
      <div className="max-w-6xl mx-auto px-4 py-12 grid gap-10 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div>
          <p className="text-xs uppercase tracking-widest text-white/50 mb-3">Explore</p>
        ...
        <div>
          <p className="text-xs uppercase tracking-widest text-white/50 mb-3">Legal</p>
          <ul className="space-y-2 text-sm text-white/70">
            <li>
        ...
        <div>
          <p className="text-xs uppercase tracking-widest text-white/50 mb-3">Support</p>
          <ul className="space-y-2 text-sm text-white/70">
            <li>
              <a
            ...
            <li className="text-white/50">Mon–Sat, 10am–7pm IST</li>
          </ul>
        </div>
      </div>

      <div className="border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4 py-5 flex flex-col sm:flex-row items-center gap-2 justify-between text-xs text-white/50">
